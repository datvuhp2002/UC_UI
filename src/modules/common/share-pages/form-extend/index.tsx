...
const Index = (props: Props) => {
  ...
  //   const getData = async () => {
  //     var res: IResponseMessage = await ItemService.Extend(UserInfo.CardNo);
  //     if (res.Success) {
    ...
    <>
      <div className="row">
        <div className="col-sm-12 mb-3">
          <h4 className="text-center">Tài liệu gia hạn</h4>
          <hr />
        </div>
      </div>
      <div className="row">
                    ...
                    item.map((e: any, ie) => {
                      return (
                        <tr key={ie}>
                          ...
                          <td className="text-center">{e.renew_date}</td>
                          <td className="text-center">{e.due_date_new}</td>
                        </tr>
                      );
                    })
                  ) : (
