...
const Index = (props: Props) => {
  ...
  //   const getData = async () => {
  //     var res: IResponseMessage = await ItemService.Returned(UserInfo.CardNo);
  //     if (res.Success) {
    ...
    <>
      <div className="row">
        <div className="col-sm-12 mb-3">
          <h4 className="text-center">Tài liệu đã trả</h4>
          <hr />
        </div>
      </div>
      <div className="row">
                    ...
                    item.map((e: any, ie) => {
                      return (
                        <tr key={ie}>
                          ...
                          <td className="text-center">{e.return_date}</td>
                        </tr>
                      );
                    })
                  ) : (
